...
var (
	...
	// ErrAuthorizationPending indicates the user hasn't completed device authorization yet
	ErrAuthorizationPending = &AuthenticationError{
		Type:    "authorization_pending",
		Message: "User has not completed device authorization",
		Code:    http.StatusAccepted,
	}

	// ErrSlowDown indicates the client is polling too frequently
	...
	ErrExpiredToken = &AuthenticationError{
		Type:    "expired_token",
...
func GetUserFriendlyMessage(err error) string {
	...
	case IsAuthenticationError(err):
		...
		case "port_in_use":
			return "The required port is already in use. Please close any applications using the port and try again."
		case "callback_timeout":
			return "Authentication timed out. Please try again."
		case "browser_open_failed":
			return "Could not open your browser automatically. Please copy and paste the URL manually."
		case "authorization_pending":
			return "Waiting for you to complete authentication in your browser..."
		case "slow_down":
			return "Polling too frequently. Slowing down..."
		case "expired_token":
